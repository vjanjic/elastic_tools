...
#ifndef ELASTICIZER_HPP_
#define ELASTICIZER_HPP_
...
inline __host__ size_t getsharedMemoryGranularity(const cudaDeviceProp &devProps) {
	...
	/*
	 * according to the architecture shared memory is allocated
...
inline __host__ size_t getMaxBlocksPerSM(const cudaDeviceProp &properties, const cudaFuncAttributes &attributes, size_t threadsPerBlock) {
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	/*
