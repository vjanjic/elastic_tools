...
////////////////////////////////////////////////////////////////////////////////
float RandFloat_k(float low, float high)
{
...
int main_out(int argc, char **argv)
{
    ...
    *d_OptionYears;
    ...
    for (i = 0; i < OPT_N; i++)
    {
        ...
        h_StockPrice[i]    = RandFloat_k(5.0f, 30.0f);
        h_OptionStrike[i]  = RandFloat_k(1.0f, 100.0f);
        h_OptionYears[i]   = RandFloat_k(0.25f, 10.0f);
    }
